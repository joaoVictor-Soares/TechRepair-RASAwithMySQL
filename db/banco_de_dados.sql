...
CREATE TABLE `ordens_servico` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_tecnicos` (`tecnicos_id`),
  KEY `fk_dispositivos` (`dispositivo_id`),
  CONSTRAINT `fk_dispositivos` FOREIGN KEY (`dispositivo_id`) REFERENCES `dispositivos` (`id`),
  CONSTRAINT `fk_tecnicos` FOREIGN KEY (`tecnicos_id`) REFERENCES `tecnicos` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-05-11 19:45:14
